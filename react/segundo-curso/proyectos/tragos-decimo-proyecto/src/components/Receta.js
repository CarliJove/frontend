...
const Receta = ({receta}) => {
    ...
    const { getReceta, setGuardarIdReceta, setGuardarReceta} = useContext(ModalContext);
    ...
    const mostrarIngredientes = getReceta => {
        ...
        for(let i = 1; i < 16; i++) {
            if(getReceta[`strIngredient${i}`]) {
                ingredientes.push(
                    <li>{getReceta[`strIngredient${i}`]} {getReceta[`strMeasure${i}`]}</li>
                );
            }
        }
                ...
                <div className="card-body">
                    ...
                    >
                        <div style = {modalStyle} className={classes.paper}>
                            ...
                            <h3 className="mt-4">Cómo mandarle mecha</h3>
                            <p>
                                {getReceta.strInstructions}
                            </p>

                            <img className="img-fluid my-4" src={getReceta.strDrinkThumb}/>
